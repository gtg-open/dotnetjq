...
| --- | --- | --- |
| Exact upstream pin | PASS | The external checkout exposed as `upstream/jq` was clean at commit `34f7186b86743a083a589741b6cea95293524108`; the exact tag is `jq-1.8.2`. |
