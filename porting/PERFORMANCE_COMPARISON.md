...
The following reproduction commands use repository-relative input locations;
they do not record the original workstation directories. Provision the pinned
oracle and expose the pinned source checkout at those locations first.
